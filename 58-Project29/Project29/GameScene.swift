...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func launch(angle: Int, velocity: Int) {
        ...
        // by default collisions are calculated each frame
        // banana is fast and could go through a player between 2 frames
        // this options makes collisions between each 2 frames be calculated as well
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        // make collisions between 2 objects (exemple: banana vs building, or building vs banana)
        // always sorted in the same order (exemple: banana vs building), to simplify further code
    ...
    func bananaHit(building: SKNode, atPoint contactPoint: CGPoint) {
        ...
        // remove name in case banana hits 2 buildings at the same time
        banana.name = ""
        banana.removeFromParent()
        banana = nil
